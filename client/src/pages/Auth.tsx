    ...
    return (
        <>
            ...
            <Modal open={needsVerification} onClose={() => setNeedsVerification(false)}>
                ...
                <p className="font-mono text-xs text-(--text-dim) leading-relaxed">
                    You need to verify <span className="text-(--text)">{email}</span> before logging in.
                </p>
                <button
                    onClick={handleResend}
                    disabled={resendLoading}
                ...
                <button
                    ...
                    className="font-mono text-[10px] tracking-widest uppercase text-(--text-dim) hover:text-(--text) transition-colors duration-200"
                >
                    Close
                </button>
            </Modal>
