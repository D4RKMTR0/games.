...
function Log() {
    ...
    return (
        ...
        >
            <section className="px-[clamp(20px,4vw,1000px)] pt-24 pb-8">
                <span className="font-mono text-xs tracking-widest uppercase text-(--text-dim)">Log</span>
                <h1 className="font-bold text-[clamp(2rem,5vw,4rem)] tracking-tight leading-tight mt-2 mb-16">What changed.</h1>
                            ...
                            >
                                ...
                                <AnimatePresence initial={false}>
                                    {isOpen && (
                                        ...
                                        >
                                            <div className="pb-8 pt-1 sm:pl-[calc(--spacing(4)+(--spacing(8))+6rem)] flex flex-col gap-4">
